...
public class RelatorioPedidosSolicitados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relatorio_pedidos_solicitados);
    ...
    public boolean checkPermissions(){
        int readPermission = ContextCompat.checkSelfPermission(RelatorioPedidosSolicitados.this, Manifest.permission.READ_EXTERNAL_STORAGE);
        if(readPermission == PackageManager.PERMISSION_GRANTED) {
            return true;
        }else{
            ActivityCompat.requestPermissions(RelatorioPedidosSolicitados.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, oqueeuquero);
        }
        return false;
    }

    public void downloadRelatorio(String TipoRelatorio, String Mes, String Ano, String dataInicio, String dataFinal){
        String url = "https://www.limopestoques.com.br/Android/Relatorios/pedidosSolicitados.php?tipoRelatorio=" + TipoRelatorio+"&mes=" +Mes+"&ano="+Ano+"&data_inicial="+dataInicio+"&data_final="+dataFinal;

        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(url));
        request.setTitle("Pedidos mais Solicitados");

        request.allowScanningByMediaScanner();
        request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);

        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "Pedidos mais Solicitados");
